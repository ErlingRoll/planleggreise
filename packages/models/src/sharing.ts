...
export const SharingInvitationStatusSchema = z.enum([
  'pending',
  'accepted',
  'declined',
  'revoked',
...
export const SharingRequestStatusSchema = z.enum([
  'pending',
  'approved',
  'denied',
])
...
export const RequestTripAccessInputSchema = z.object({
...
export type SharingInvitationStatus = z.infer<
  typeof SharingInvitationStatusSchema
>
...
export type RequestTripAccessInput = z.infer<
  typeof RequestTripAccessInputSchema
>
