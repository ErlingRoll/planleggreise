  ...
  nb: {
    translation: {
      ...
      tripDetails: {
        ...
        googleMapsActivity: 'Google Maps',
        googleMapsHelp: 'Navnet og adressen hentes automatisk fra lenken.',
        googleMapsPlaceholder: 'https://maps.app.goo.gl/...',
        googleMapsUrl: 'Google Maps-lenke',
        manualActivity: 'Skriv selv',
  ...
  en: {
    translation: {
      ...
      tripDetails: {
        ...
        googleMapsActivity: 'Google Maps',
        googleMapsHelp: 'The name and address are fetched automatically from the link.',
        googleMapsPlaceholder: 'https://maps.app.goo.gl/...',
        googleMapsUrl: 'Google Maps link',
        manualActivity: 'Write manually',
